...
public class RefreshLoadMoreLayout extends ViewGroup {
    ...
    private void initViews(AttributeSet attributeSet) {
        ...
        if (null != attributeSet) {
            typedArray = getContext().obtainStyledAttributes(attributeSet,
                    R.styleable.VRefreshLoadLayout);
        }
    ...
    private void initCommonViews(TypedArray typedArray) {
        ...
        if (null != typedArray) {
            ...
            indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_bg,
                    R.styleable.VRefreshLoadLayout_rll_textcolor
            };
    ...
    private void initHeaderViews(TypedArray typedArray) {
        ...
        if (null != typedArray) {
            int[] indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_header_hint_normal,
                    R.styleable.VRefreshLoadLayout_rll_header_hint_ready,
                    R.styleable.VRefreshLoadLayout_rll_header_hint_loading,
                    R.styleable.VRefreshLoadLayout_rll_header_last_time,
                    R.styleable.VRefreshLoadLayout_rll_header_time_justnow,
                    R.styleable.VRefreshLoadLayout_rll_header_time_minutes,
                    R.styleable.VRefreshLoadLayout_rll_header_time_hours,
                    R.styleable.VRefreshLoadLayout_rll_header_time_days
            };
            ...
            indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_arrow,
                    R.styleable.VRefreshLoadLayout_rll_header_progress
            };
            indexLength = indexs.length;
            for (int i = 0; i < indexLength; i++) {
            ...
            indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_header_progress_size,
                    R.styleable.VRefreshLoadLayout_rll_header_arrow_width,
                    R.styleable.VRefreshLoadLayout_rll_header_arrow_height,
                    R.styleable.VRefreshLoadLayout_rll_header_title_size,
                    R.styleable.VRefreshLoadLayout_rll_header_subtitle_size,
                    R.styleable.VRefreshLoadLayout_rll_header_content_margin,
                    R.styleable.VRefreshLoadLayout_rll_header_height
            };
            indexLength = indexs.length;
            for (int i = 0; i < indexLength; i++) {
    ...
    private void initFooterViews(TypedArray typedArray) {
        ...
        if (null != typedArray) {
            int[] indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_footer_hint_normal,
                    R.styleable.VRefreshLoadLayout_rll_footer_hint_ready,
                    R.styleable.VRefreshLoadLayout_rll_footer_hint_loading,
                    R.styleable.VRefreshLoadLayout_rll_footer_no_more_data
            };
            int indexLength = indexs.length;
            for (int i = 0; i < indexLength; i++) {
            ...
            indexs = new int[]{
                    R.styleable.VRefreshLoadLayout_rll_footer_content_margin,
                    R.styleable.VRefreshLoadLayout_rll_footer_progress_size,
                    R.styleable.VRefreshLoadLayout_rll_footer_title_size,
                    R.styleable.VRefreshLoadLayout_rll_footer_height
            };
            indexLength = indexs.length;
            for (int i = 0; i < indexLength; i++) {
                sizes[i] = typedArray.getDimension(indexs[i], sizes[i]);
            ...
            Drawable _drawable = typedArray.getDrawable(R.styleable.VRefreshLoadLayout_rll_footer_progress);
            if (null != _drawable) {
                drawable = _drawable;
            }
        }
    ...
    public static class Config {
        ...
        private String mKeyLastRefreshTime = "";
        private String mHeaderDateFormat = "yyyy-MM-dd";
        private boolean mCanLoadMore = true;
        private boolean mAutoLoadMore = false;
        private boolean mMultiTask = false;
         ...
         */
        public Config showLastRefreshTime(String dateFormat) {
            mShowLastRefreshTime = true;
            mKeyLastRefreshTime = "911288799";
            ...
            ((RecyclerView) cv).addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (dy > 0 && isCanLoadMore() && RefreshLoadMoreUtil.isContentToBottom(cv) || dy < 0 && isCanRefresh() && RefreshLoadMoreUtil
                            .isContentToTop(cv)) {
                        //滑动到顶部或者底部，自动调用了VRefreshLoadLayout的requestDisallowInterceptTouchEvent(true)
                        //所以我们需要延迟设置为false
