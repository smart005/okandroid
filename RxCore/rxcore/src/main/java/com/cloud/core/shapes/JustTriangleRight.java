 ...
 * @CreateTime:2015-11-6 上午10:49:43
 * @Description: 剪头向右正三角形
 * @Modifier:
 * @ModifyContent:
 */
public class JustTriangleRight extends View {
    ...
    public JustTriangleRight(Context context, int justTriangleUpBackgroundColor) {
        super(context);
        this.justTriangleUpBackgroundColor = justTriangleUpBackgroundColor;
        init();
    }

    public JustTriangleRight(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
