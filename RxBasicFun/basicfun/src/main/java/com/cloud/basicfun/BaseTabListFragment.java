...
import com.cloud.resources.tablist.TabLayoutListFragment;
 ...
 * @ModifyContent:
 */
public class BaseTabListFragment extends TabLayoutListFragment {
    /**
     * 当前分页索引
     */
    ...
    public static <T extends BaseTabListFragment> T newInstance(T t, Bundle args) {
        if (args != null) {
            t.setArguments(args);
        }
        return t;
    ...
    public static <T extends BaseTabListFragment> T newInstance(T t, String param) {
    ...
    public static <T extends BaseTabListFragment> T newInstance(T t) {
    ...
    private WinObjectUtils mwoutils = new WinObjectUtils() {
        @Override
        protected void receiveRSCResult(Intent intent) {
            BaseTabListFragment.this.receiveRSCResult(intent);
        }

        @Override
        protected void receiveRSCResult(Intent intent, String action) {
            BaseTabListFragment.this.receiveRSCResult(intent, action);
        }
