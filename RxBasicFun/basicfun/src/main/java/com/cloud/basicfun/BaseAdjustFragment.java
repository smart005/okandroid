...
import com.cloud.resources.parallax.BaseAdjustScrollFragment;
 ...
 * @ModifyContent:
 */
public class BaseAdjustFragment extends BaseAdjustScrollFragment {
    /**
     * 当前分页索引
     */
    ...
    public static <T extends BaseAdjustFragment> T newInstance(T t, Bundle args) {
        if (args != null) {
            t.setArguments(args);
        }
        return t;
    ...
    public static <T extends BaseAdjustFragment> T newInstance(T t, String param) {
    ...
    public static <T extends BaseAdjustFragment> T newInstance(T t) {
    ...
    private WinObjectUtils mwoutils = new WinObjectUtils() {
        @Override
        protected void receiveRSCResult(Intent intent) {
            BaseAdjustFragment.this.receiveRSCResult(intent);
        }

        @Override
        protected void receiveRSCResult(Intent intent, String action) {
            BaseAdjustFragment.this.receiveRSCResult(intent, action);
        }
