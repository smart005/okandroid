...
public class XRefreshScrollView extends ScrollView implements OnScrollListener {
//    private static final String TAG = "XScrollView";
    ...
    public XRefreshScrollView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderContent = (LinearLayout) mHeader.findViewById(R.id.xlistview_header_content);
        ...
        this.setRefreshTime(DateUtils.getDateTime(DateFormatEnum.YYYYMMDDHHMMSS));
    }
    ...
    private void updateHeaderHeight(float delta) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                XRefreshScrollView.this.fullScroll(ScrollView.FOCUS_UP);
            }
        });
    }
    ...
    private void updateFooterHeight(float delta) {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                XRefreshScrollView.this.fullScroll(ScrollView.FOCUS_DOWN);
            }
        });
    }
    ...
    private boolean isTop() {
        return getScrollY() <= 0 || mHeader.getVisiableHeight() > mHeaderHeight || mContentLayout.getTop() > 0;
    }
