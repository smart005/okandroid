package com.cloud.resources.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected View makeHeaderView() {
        ...
        topButtonLayout.setLayoutParams(new RelativeLayout.LayoutParams(MATCH_PARENT, PixelUtils.dip2px(activity, topHeight)));
        ...
        int margin = PixelUtils.dip2px(activity, 20);
