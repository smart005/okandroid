 ...
 * use this file kt in compliance with the License. You may obtain a copy of the
 * License at
 * <p/>
 ...
 * @CreateTime:2015-11-17 上午10:39:30
 * @Description: 分组列表
 * @Modifier:
 * @ModifyContent:
 */
public class PinnedSectionListView extends ListView implements OnScrollListener {
    ...
    private OnPinnedSectionListener mOnPinnedSectionListener = null;

    public void setOnPinnedSectionListener(OnPinnedSectionListener listener) {
        mOnPinnedSectionListener = listener;
    }

    private OnPinnedScrollListener onPinnedScrollListener = null;

    public void setOnPinnedScrollListener(OnPinnedScrollListener listener) {
        this.onPinnedScrollListener = listener;
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (totalItemCount > visibleItemCount) {
            if (mOnPinnedSectionListener != null) {
                mOnPinnedSectionListener.onFullScreenListener(true);
            }
        } else {
            if (mOnPinnedSectionListener != null) {
                mOnPinnedSectionListener.onFullScreenListener(false);
            }
        }
        if (onPinnedScrollListener != null) {
            onPinnedScrollListener.onPinnedScroll(view, firstVisibleItem, visibleItemCount, totalItemCount);
        }
    }
}
